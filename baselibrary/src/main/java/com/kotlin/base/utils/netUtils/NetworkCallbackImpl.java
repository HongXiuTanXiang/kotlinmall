package com.kotlin.base.utils.netUtils;
...
public class NetworkCallbackImpl extends ConnectivityManager.NetworkCallback {
    ...
    private List<MethodManager> findAnnotationMethods(Object observer) {
        ...
        for (Method method : methods) {
            //获取方法注解
            com.kotlin.base.utils.netUtils.Network network = method.getAnnotation(com.kotlin.base.utils.netUtils.Network.class);
            if (network == null) {
                continue;
            }
            //方法参数校验
